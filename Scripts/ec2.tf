# ec2.tf - Instâncias EC2 (se preferir ao invés de Fargate)
...
resource "aws_security_group" "ec2" {
  ...
  ingress {
    ...
    to_port     = 22
    protocol    = "tcp"
    cidr_blocks = ["0.0.0.0/0"] # ATENÇÃO: Muito inseguro! Use seu IP específico
  }
...
# Policy para EC2 acessar ECR (se usar Docker)
